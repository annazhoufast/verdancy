...
var newUserJ = []byte(`{"Email": "test@test.com", "Password": "password123", "PasswordConf": "password123", "FirstName": "firstname", "LastName": "lastname"}`)
var jsonStr = []byte(`{"ID": 1, "Email": "test@test.com", "PassHash": []byte("passhash123"), "FirstName": "firstname", "LastName": "lastname"}`)
